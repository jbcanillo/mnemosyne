...
const options = {
  definition: {
    ...
    info: {
      ...
      version:     '1.0.0',
      description: 'REST API for the Mnemosyne RAG Knowledge Base system. All endpoints except `POST /api/auth/login` require authentication via `X-API-Key` (server-to-server) or `X-Session-Token` (UI/browser).',
    ...
    components: {
      securitySchemes: {
        ...
        SessionToken: { type: 'apiKey', in: 'header', name: 'X-Session-Token',description: 'Session token obtained from POST /auth/login' }
      },
      schemas: {
        Error: {
          type: 'object',
        ...
        Settings: {
          type: 'object',
          properties: {
            llmEngine:            { type: 'string', enum: ['','openrouter','local'], description: 'LLM engine: empty=auto-detect' },
            ...
            localLlmModel:        { type: 'string', example: 'llama3.2' },
        ...
        Document: {
          ...
          properties: {
            ...
            ocrMethod:  { type: 'string', enum: ['pdf-parse','tesseract-ocr','mammoth','xlsx','markdown','none'] }
          }
        },
        Session: {
          type: 'object',
    ...
    paths: {
      ...
      '/auth/verify': {
        get: {
          tags: ['Auth'],
          summary: 'Verify session token is still valid',
          responses: {
            200: {
      ...
      '/query': {
        post: {
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    async:    { type: 'boolean', default: false, description: 'If true, returns a jobId to poll' },
                    options:  {
                      type: 'object',
                      properties: {
          ...
          responses: {
            ...
            202: { description: 'Async job queued' },
      ...
      '/query/status/{jobId}': {
        get: {
          tags: ['Query'],
          summary: 'Poll status of an async query job',
          security: [{ ApiKeyAuth: [] }, { SessionToken: [] }],
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      ...
                      totalChunksReturned:   { type: 'integer' },
            ...
            content: {
              'multipart/form-data': {
                schema: {
                  ...
                  required: ['file'],
                  properties: {
                    file: { type: 'string', format: 'binary', description: 'PDF, DOCX, XLSX, CSV, MD, TXT, PNG, JPG, JPEG, GIF, BMP, TIFF, TIF (max 50 MB)' },
      ...
      '/documents/tags': {
        get: {
          tags: ['Documents'],
          summary: 'List all unique tags across documents',
          responses: {
            200: {
      ...
      '/documents/ingest-status/{jobId}': {
        get: {
          ...
          parameters: [{ name: 'jobId', in: 'path', required: true, schema: { type: 'string' } }],
          responses: {
            200: { description: 'Job state (waiting/active/completed/failed)' },
            404: { description: 'Job not found' }
          }
        }
      },
      ...
      '/models': {
        get: {
          tags: ['Models'],
          summary: 'List available free OpenRouter models',
          responses: {
            200: {
      ...
      '/models/switch': {
        post: {
          tags: ['Models'],
          summary: 'Switch active LLM at runtime (no restart needed)',
          requestBody: {
            required: true,
            content: {
              'application/json': {
                schema: {
                  ...
                  required: ['modelId'],
                  properties: {
                    modelId: { type: 'string', example: 'meta-llama/llama-3.1-8b-instruct:free' }
                  }
                }
              }
            }
      ...
      '/models/{modelId}': {
        delete: {
          tags: ['Models'],
          summary: 'Remove a custom LLM model',
      ...
      '/models/{modelId}/test': {
        post: {
          tags: ['Models'],
          summary: 'Test an OpenRouter model with a simple prompt',
          parameters: [{ name: 'modelId', in: 'path', required: true, schema: { type: 'string' } }],
          responses: {
            200: {
      ...
      '/models/reset': {
        post: {
          tags: ['Models'],
          summary: 'Reset models to default list',
      ...
      '/local-model/check': {
        post: {
          tags: ['Models'],
          summary: 'Check if an Ollama model exists locally',
          requestBody: {
            required: true,
            content: {
              'application/json': {
          ...
          responses: {
            200: {
              ...
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/LocalModelCheckResponse' }
                }
              }
            }
          }
      ...
      '/local-model/pull': {
        post: {
          tags: ['Models'],
          summary: 'Pull an Ollama model from the registry',
          requestBody: {
            required: true,
            content: {
              'application/json': {
          ...
          responses: {
            200: {
              ...
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/LocalModelPullResponse' }
                }
              }
            }
          }
      ...
      '/settings': {
        get: {
          tags: ['Settings'],
          summary: 'Get current configuration (API key is masked)',
          responses: {
            200: {
        ...
        put: {
          tags: ['Settings'],
          summary: 'Update one or more settings — persisted to disk',
          requestBody: {
            required: true,
            content: {
              'application/json': {
      ...
      '/settings/test-key': {
        post: {
          tags: ['Settings'],
          summary: 'Test the current OpenRouter API key with a live ping',
          responses: {
            200: {
              description: 'Test result',
              content: {
      ...
      '/info': {
        get: {
          tags: ['System'],
          summary: 'Server info and metrics (requires session)',
      ...
      '/diagnostics': {
        get: {
          tags: ['System'],
          summary: 'Full connectivity check (Ollama, OpenRouter, ChromaDB, Redis)',
      ...
      '/vector-store/reset': {
        post: {
          tags: ['System'],
          summary: 'Wipe and recreate vector store collection',
      ...
      '/usage': {
        ...
        delete: {
          tags: ['System'],
          summary: 'Reset token usage statistics',
      ...
      '/sessions/{id}/clear': {
        post: {
          tags: ['Sessions'],
          summary: 'Clear all messages from a session',
          parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }],
      ...
      '/backup/create': {
        post: {
          tags: ['Backups'],
          summary: 'Create a backup of ChromaDB and config',
          responses: {
            200: {
      ...
      '/analytics/overview': {
        get: {
          tags: ['Analytics'],
          summary: 'Get analytics overview with system metrics',
          responses: {
            200: {
      ...
      '/analytics/tags': {
        get: {
          tags: ['Analytics'],
          summary: 'Get tag statistics and co-occurrence relationships',
          responses: {
            200: {
              description: 'Tag analytics',
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/AnalyticsTags' }
                }
              }
            }
          }
      ...
      '/analytics/sessions': {
        get: {
          tags: ['Analytics'],
          summary: 'Get session analytics with daily breakdown',
          responses: {
            200: {
              description: 'Session analytics',
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/AnalyticsSessions' }
                }
              }
            }
          }
      ...
      '/analytics/usage': {
        get: {
          tags: ['Analytics'],
          summary: 'Get token usage, cache stats, and queue metrics',
          responses: {
            200: {
              description: 'Usage analytics',
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/AnalyticsUsage' }
                }
              }
            }
          }
